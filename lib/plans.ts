...
export const plans: PlanDefinition[] = [
  ...
  { id: "growth", name: "Growth", price: 299, promise: "Run a growing prep center and protect earned revenue.", warehouses: 2, customers: 25, monthlyOperations: 10000, highlighted: true, features: ["Everything in Starter", "Prep and outbound workspaces", "Barcode scanner setup and lookup", "Customer service rates", "Revenue Protection", "Priority email support"] },
